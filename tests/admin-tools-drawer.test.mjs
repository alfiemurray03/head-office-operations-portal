...
assert.match(styles, /@media \(min-width: 1024px\)[\s\S]*grid-template-columns:\s*248px minmax\(0, 1fr\) !important/, 'Desktop must reserve a stable navigation column instead of shifting the page.');
